namespace VRTK
{
    ...
    public static class VRTK_SDK_Bridge
    {
        ...
        public static GameObject GetControllerLeftTracker(bool actual)//获得真实世界的trakcer对象
        {
            return GetControllerSDK().GetControllerByIndex(3, actual);
        }

        public static GameObject GetControllerRightTracker(bool actual)//获得真实世界的trakcer对象
        {
            return GetControllerSDK().GetControllerByIndex(4, actual);
        }
