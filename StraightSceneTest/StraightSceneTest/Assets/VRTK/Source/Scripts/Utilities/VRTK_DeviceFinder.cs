...
namespace VRTK
{
    ...
    public static class VRTK_DeviceFinder
    {
        ...
        public static GameObject GetControllerLeftTracker(bool getActual = false)//使用控制器的Index获得Tracker设备
        {

            return VRTK_SDK_Bridge.GetControllerByIndex(3, getActual);

        }

        public static GameObject GetControllerRightTracker(bool getActual = false)//使用控制器的Index获得Tracker设备
        {

            return VRTK_SDK_Bridge.GetControllerByIndex(4, getActual);
